...
random_files = ['roc_curve_info/random_NN.npy',\
				'roc_curve_info/random_KNN.npy',\
				'roc_curve_info/random_train_test_depth_norm.npy',\
				'roc_curve_info/random_train_test_depth_norm_w_nn.npy',\
				'roc_curve_info/random_train_test_depth_norm_w_knn.npy']
random_label_names = ['Nearest Neighbor',\
